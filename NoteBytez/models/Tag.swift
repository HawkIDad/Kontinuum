...
final class Tag: Codable, Identifiable {
    ...
    /// Canonical (case-folded, trimmed) form — the dedupe key. See `TagParser.canonicalize`.
    var name: String?
    var libraryId: UUID?
    ...
    enum CodingKeys: String, CodingKey {
        case name, libraryId, createdOn, createdBy, updatedOn, updatedBy, isActive, tagId
    }
    ...
    convenience init(from decoder: Decoder) throws {
        ...
        self.tagId = try container.decodeIfPresent(UUID.self, forKey: .tagId)
    }
