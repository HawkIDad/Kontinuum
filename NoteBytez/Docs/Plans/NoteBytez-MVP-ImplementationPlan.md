...
- [x] CloudKit container configured (`iCloud.com.g9Consulting.Kontinuum`) and wired into [NoteBytez.entitlements](../../NoteBytez.entitlements) — verified via `xcodebuild -list`
