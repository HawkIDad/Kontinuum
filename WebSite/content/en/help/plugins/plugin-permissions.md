...
title: "Understand plugin permissions"
description: "See what each plugin permission allows."
category: plugins
order: 2
appliesTo: ["1.0"]
platforms: ["iPhone","iPad","Mac"]
personas: ["Power User"]
featureSlug: plugin-permissions
lastReviewed: "2026-09-19"
type: howto
permalink: /en/help/plugins/plugin-permissions/
---

## Purpose

See what each plugin permission allows.
